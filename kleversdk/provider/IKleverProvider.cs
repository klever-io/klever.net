...
namespace kleversdk.provider
{
    public interface IKleverProvider
    {
        ...
        Task<provider.Dto.Transaction> Proposal(string fromAddr, long nonce, List<KeyValuePair<string, string>> Parameter, long epochsDuration, string Description = null);
        ...
        Task<provider.Dto.Transaction> TriggerAsset(string fromAddr, long nonce, int triggerType, string assetID, string receiver = null, float amount = default, List<KeyValuePair<string, string>> uris = null, string logo = null, string mime = null, provider.Dto.Role role = null, provider.Dto.StakingObject staking = default);
        ...
        Task<provider.Dto.Transaction> CreateValidator(string fromAddr, long nonce, string name, string address, string rewardAddress, string bls = null, bool canDelegate = default, float maxDelegationAmount = default, float comission = default, string logo = null, List<KeyValuePair<string, string>> uris = null);
        Task<provider.Dto.Transaction> ConfigValidator(string fromAddr, long nonce, string name, string rewardAddress, string bls = null, bool canDelegate = default, float maxDelegationAmount = default, float comission = default, string logo = null, List<KeyValuePair<string, string>> uris = null);
